...
public class coupledSimulator extends atomicSimulator
        ...
        if (o != null && !o.isEmpty()) {
            ...
            while (rit.hasNext()) {
                ...
                if (modelToSim.get(ds) instanceof CoupledSimulatorInterface) {
                    ...
                    if (cci != null) {
                        myParent.putMyMessages(co);
                    } else if (ci != null) {
                        myRootParent.putMyMessages(co);
                    }
                }
            }
        }
     ...
     *
     * @param oldContent The content object that existed before its traversal of
     * the coupling.
     * @param coupling The coupling traversed by the content.
     * @param newContent The content object as it stands now after the
     * traversal.
     * @param sourceComponentName The name of the component at the beginning of
     * the coupling.
     * @param destComponentName The name of the component at the end of the
     * coupling.
     */
